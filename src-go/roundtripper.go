...
default:
		// 🚀 Senior Fix: تفعيل الـ Keep-Alive وبركة الاتصالات الصاروخية لـ HTTP/1.x
		rt.cachedTransports[addr] = &http.Transport{
			DialTLSContext:        rt.dialTLS,
			DisableKeepAlives:     false, // السماح بإعادة استخدام الـ Sockets
			MaxIdleConns:          1000,  // أقصى عدد للاتصالات في الذاكرة
			MaxIdleConnsPerHost:   100,   // يمكنه فتح حتى 100 اتصال متزامن لنفس الموقع
			IdleConnTimeout:       60 * time.Second, // إغلاق الـ Socket تلقائياً إذا ظل خاملاً لـ 60 ثانية
